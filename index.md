...
helper: ["Phredd Groves (UCSC)", "Kristi Liu (UCSB)", "Amber Xuqian Chen (UCSB)", "Geno Sanchez (UCLA)", "Stephanie Labou (UCSD)", "Alejandra Sicairos (UCSB)", "Amber Xuqian Chen (UCSB)" ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
